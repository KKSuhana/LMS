...
db = sqlite3.connect('Admin.db') #Connection for admin database
dbstore = sqlite3.connect('StoreBooks.db') #Connection for StoreBooks database
dbstudents = sqlite3.connect('StudentsData.db') #Connection for studentsdata database

#main window
root = Tk()
root.title("Library Management System")
root.iconbitmap(r'C:\Users\THAMEEM\Desktop\PROJECT\library-management-files\filename\aa.ico')
...
class main:
    def login(self):
        ...
        if self.ab != None:
            ...
            self.ig = PhotoImage(file=r'C:\Users\THAMEEM\Desktop\PROJECT\library-management-files\filename\library.png') #dashboard image
            self.lbb.config(image=self.ig)

            self.lb3 = Label(self.fm2, text='DASHBOARD', fg='White', bg='black', font=('times new roman', 30, 'bold'))
    ...
    def cur(self):
        ...
        self.photo9 = PhotoImage(file=r"C:\Users\THAMEEM\Desktop\PROJECT\library-management-files\filename\afterlogin1.png")
        self.canvas8.create_image(0, 0, image=self.photo9, anchor=NW)

        self.develop = Label(self.fm3, text='WELCOME', bg='#fff', fg='black',font = ('Candara', 12, 'bold'))
        self.develop.place(x=732, y=350)

        #AddButton
        self.bt1 = Button(self.fm3, text='  Add Books', fg='#fff', bg='black', font=('Candara', 15, 'bold'),
        ...
        self.logo = PhotoImage(file=r'C:\Users\THAMEEM\Desktop\PROJECT\library-management-files\filename\bt1.png')
        ...
        # IssueButton
        self.bt2 = Button(self.fm3, text='  Issue Books', fg='#fff', bg='black', font=('Candara', 15, 'bold'),
                          width=170, height=0, bd=7, relief='flat', command=self.issuebook, cursor='hand2',
                          activebackground='black', activeforeground='#581845')
        self.bt2.place(x=250, y=40)
        self.log = PhotoImage(file=r'C:\Users\THAMEEM\Desktop\PROJECT\library-management-files\filename\bt2.png')
        self.bt2.config(image=self.log, compound=LEFT)
        self.small_log = self.log.subsample(1, 1)
        self.bt2.config(image=self.small_log)

        #EditButton
        self.bt3 = Button(self.fm3, text='  Edit Books', fg='#fff', bg='black', font=('Candara', 15, 'bold'),
                          width=170, height=0, bd=7, relief='flat', cursor='hand2', command=self.edit,
                          activebackground='black', activeforeground='#581845')
        self.bt3.place(x=40, y=120)
        self.logb = PhotoImage(file=r'C:\Users\THAMEEM\Desktop\PROJECT\library-management-files\filename\bt3.png')
        ...
        #ReturnButton
        self.bt4 = Button(self.fm3, text='  Return Books', fg='#fff', bg='black', font=('Candara', 15, 'bold'),
                          width=170, height=0, bd=7, relief='flat', cursor='hand2', command=self.returnbook,
                          activebackground='black', activeforeground='#581845')
        self.bt4.place(x=250, y=120)
        self.log4 = PhotoImage(file=r'C:\Users\THAMEEM\Desktop\PROJECT\library-management-files\filename\bt4.png')
        ...
        #DeleteButton
        self.bt5 = Button(self.fm3, text=' Delete Books', fg='#fff', bg='black', font=('Candara', 15, 'bold'),
                          width=170, height=0, bd=7, relief='flat', cursor='hand2', command=self.delete,
                          activebackground='black', activeforeground='#581845')
        self.bt5.place(x=40, y=200)
        self.log5 = PhotoImage(file=r'C:\Users\THAMEEM\Desktop\PROJECT\library-management-files\filename\bt5.png')
        ...
        #ShowButton
        self.bt6 = Button(self.fm3, text=' Show Books', fg='#fff', bg='black', font=('Candara', 15, 'bold'),
                          width=170, height=0, bd=7, relief='flat', cursor='hand2', command=self.show,
                          activebackground='black', activeforeground='#581845')
        self.bt6.place(x=40, y=280)
        self.log6 = PhotoImage(file=r'C:\Users\THAMEEM\Desktop\PROJECT\library-management-files\filename\bt6.png')
        ...
        #SearchButton
        self.bt7 = Button(self.fm3, text='  Search Books', fg='#fff', bg='black', font=('Candara', 15, 'bold'),
                          width=170, height=0, bd=7, relief='flat', cursor='hand2', command=self.search,
                          activebackground='black', activeforeground='#581845')
        self.bt7.place(x=250, y=200)
        self.log7 = PhotoImage(file=r'C:\Users\THAMEEM\Desktop\PROJECT\library-management-files\filename\bt7.png')
        ...
        try:
            ...
            self.bt8 = Button(self.fm3, text='  Log Out', fg='#fff', bg='black', font=('Candara', 15, 'bold'),
                              width=170, height=0, bd=7, relief='flat', cursor='hand2', command=self.code,
                              activebackground='black', activeforeground='#581845')
            self.bt8.place(x=250, y=280)
            self.log8 = PhotoImage(file=r'C:\Users\THAMEEM\Desktop\PROJECT\library-management-files\filename\bt8.png')
            ...
            self.log9 = PhotoImage(file=r'C:\Users\THAMEEM\Desktop\PROJECT\library-management-files\filename\bt8.png')
    ...
    def addbook(self):
        class temp(main):
            def book(self):
                ...
                self.log = PhotoImage(file=r'C:\Users\THAMEEM\Desktop\PROJECT\library-management-files\filename\backbtn1.png')
                ...
                self.fll = Frame(self.fm1, width=150, height=40, bg='#581845')
                self.fll.place(x=150, y=15)
                self.ll = Label(self.fll, text='ADD BOOKS', fg='#fff', bg='#581845', font=('Canara', 12, 'bold'),width=15)
                ...
                # Submit Button
                self.bt = Button(self.fm1, text='SUBMIT', width=8, fg='white', bg='#581845',
    ...
    def issuebook(self):
        class test(main):
            ...
            def issue(self):
                ...
                self.ffbll = Frame(self.fc, bg='#581845', bd=2, relief='flat', width=210, height=40)
                self.ffbll.place(x=50, y=0)

                self.lc = Label(self.ffbll, text='STUDENT  INFORMATION', bg='#581845', fg='#fff', font=('Arial', 12, 'bold'))
                ...
                # Submit Button for Regno
                self.bt = Button(self.fc, text='SUBMIT', width=8, bg='#581845', fg='#fff', font=('Canara', 12, 'bold'), bd=5,
                 relief='flat', command=self.check, activeforeground='#00203f', activebackground='#adefd1')
            ...
            def check(self):
                ...
                #cursor.execute("CREATE TABLE Students(Regno INT Primary Key Unique Not NULL,Name CHAR,Course CHAR,"
                       #   "Year CHAR,Rollno INT,Email CHAR Unique,ContactNo INT Unique,FromDate DATE,ToDate CHAR,SubmitDate CHAR,Charge INT,NoBook INT Not NULL)")
                cursor.execute("INSERT or IGNORE INTO Students (NoBook,Charge,SubmitDate,ToDate,FromDate,ContactNo,Email,Rollno,Year,Course,Name,Regno)VALUES (0,NULL,NULL,NULL,NULL,9876543210,'suhana@gmail.com',10,2,'MSc','suhana',1001);")
                cursor.execute("INSERT or IGNORE INTO Students (NoBook,Charge,SubmitDate,ToDate,FromDate,ContactNo,Email,Rollno,Year,Course,Name,Regno)VALUES (0,NULL,NULL,NULL,NULL,7896451032,'fathima@gmail.com',18,3,'BSc','fathima',1002);")
                cursor.execute("INSERT or IGNORE INTO Students (NoBook,Charge,SubmitDate,ToDate,FromDate,ContactNo,Email,Rollno,Year,Course,Name,Regno)VALUES (0,NULL,NULL,NULL,NULL,8759634211,'dipin@gmail.com',5,1,'MA','dipin',1003);")
                ...
                if self.var != None:
                    ...
                    self.bt1 = Button(self.fr, text='SUBMIT', width=8, bg='#adefd1', fg='#00203f', font=('Canara', 12, 'bold'), bd=5,
                                      relief='flat', command=self.data, activeforeground='#adefd1', activebackground='#00203f')
            ...
            def data(self):
                ...
                cursor = dbstore.cursor()
                #cursor.execute("CREATE TABLE Books(BookID INT Primary Key Unique Not NULL,Title CHAR Not NULL,Author CHAR Not NULL,Edition CHAR Not NULL,Price INT Not NULL,Issue CHAR,ID INT)")
                cursor.execute("INSERT or IGNORE INTO Books ([ID],Issue,Price,Edition,Author,Title,BookID)VALUES (NULL,NULL,1100,2006,'Balaguruswamy','C Programming',5000);")
                cursor.execute("INSERT or IGNORE INTO Books ([ID],Issue,Price,Edition,Author,Title,BookID)VALUES (NULL,NULL,900,2011,'N Mark','JAVA',5001);")
                cursor.execute("INSERT or IGNORE INTO Books ([ID],Issue,Price,Edition,Author,Title,BookID)VALUES (NULL,NULL,1500,2020,'Guido Van Rossum','Python',5002);")
                cursor.execute("INSERT or IGNORE INTO Books ([ID],Issue,Price,Edition,Author,Title,BookID)VALUES (NULL,NULL,1050,2000,'Silberschatz','OS',5003);")
                cursor.execute("INSERT or IGNORE INTO Books ([ID],Issue,Price,Edition,Author,Title,BookID)VALUES (NULL,NULL,1000,2009,'K Darvin','C++',5004);")
                ...
                if self.value != None:
                    if (self.flag != 1):
                        ...
                        self.boot.iconbitmap(r"C:\Users\THAMEEM\Desktop\PROJECT\library-management-files\filename\aa.ico")
                        ...
                        btn1 = Button(self.boot, text="CONFIRM DATE", command=self.get_data, bg='#343148', font=('Canara', 11, 'bold'),
            ...
            def issued(self):
                ...
                if self.n <= 3:
                    ...
                    self.regid1 = self.em2.get()
                    book.execute("SELECT * FROM Students WHERE Regno='"+self.regid1+"'")
                ...
                comm.execute("UPDATE Students SET FromDate='"+str(self.x)+"', ToDate='"+str(self.datecon)+"', SubmitDate='' WHERE Regno='"+self.b+"'")
                dbstudents.commit()
            ...
            def mail(self):
                self.regid = self.em2.get()
                cursor = dbstudents.cursor()
                cursor.execute("SELECT * FROM Students WHERE Regno='"+self.regid+"'")
                self.var = cursor.fetchone()
                sender = "libraryauthority@gmail.com"
                reciever = self.var[5]
                with open(file=r'C:\Users\THAMEEM\Desktop\PROJECT\pass\pass.txt') as file:
                    password = file.read()
    ...
    def edit(self):
        class editing(main):
            def edbooks(self):
                ...
                self.ed = Frame(self.fm1, bg='#581845', bd=0, relief='flat', width=160, height=35)
                self.ed.place(x=170, y=0)
                self.lab = Label(self.ed, text='EDIT BOOK DETAILS', bg='#581845', fg='#fff',
                ...
                # Search Button
                self.button7 = Button(self.fm1, text='SEARCH', bg='#581845', fg='#fff', width=8,
            ...
            def searchedit(self):
                ...
                if self.val != None:
                    ...
                    self.edcat.iconbitmap(r"C:\Users\THAMEEM\Desktop\PROJECT\library-management-files\filename\aa.ico")
                    ...
                    self.butt = Button(self.edcat, text='SUBMIT', bg='#1c1c1b', fg='#ce4a7e', width=8, font=('Calibri', 12, 'bold'),
                                       command=self.savedit, relief='flat')
    ...
    def returnbook(self):
        class retu(main):
            def __init__(self):
                ...
                #Regno
                self.label8 = Label(self.f1, text='RegNO', bg='#ffe8ec', fg='black', font=('Times New Roman', 11, 'bold'))
            ...
            def retsucc(self):
                ...
                cursor1.execute(
                    "UPDATE Students SET FromDate='',ToDate='',Charge='"+str(self.charge)+"' WHERE Regno='"+self.entry+"'")
                dbstudents.commit()
            ...
            def retbook(self):
                ...
                if self.data != None:
                    if (int(self.data[11]) >= 1):
                        ...
                        if self.var != None:
                            ...
                            if chm <= 0:
                                ...
                                self.tom.iconbitmap(r"C:\Users\THAMEEM\Desktop\PROJECT\library-management-files\filename\aa.ico")
                                ...
                                self.varr = str(self.var[10])
                                self.charge = str(5 * chm) + self.varr
                                ...
                                self.tombtn = Button(self.tom, text='SUBMIT', background='#581845', foreground='white', font=('Calibri', 12, 'bold'),
                                                     width=8, activebackground='black', activeforeground='#581845', relief='flat', command=self.retsucc)
                            ...
                            cursor1 = dbstudents.cursor()
                            cursor1.execute("UPDATE Students SET FromDate='',ToDate='',Charge='"+str(self.charge)+"' WHERE Regno='"+self.entry+"'")
                            dbstudents.commit()
                    ...
                    messagebox.showerror("Invalid Regno", "This student doesn't exist!")
                    self.entry4.delete(0, END)
    ...
    def delete(self):
        class dele(main):
            def deletebooks(self):
                ...
                self.f1.place(x=200, y=15)
                self.ed = Frame(self.f1, bg='#581845', bd=0, relief='flat', width=120, height=30)
                self.ed.place(x=150, y=0)
                self.lac = Label(self.ed, text='DELETE BOOKS ', bg='#581845', fg='#fff', font=('Calibri', 12, 'bold'))
                ...
                # Delete Books Button
                self.button9 = Button(self.f1, text='DELETE', bg='#581845', fg='#fff', width=8,
    ...
    def search(self):
        class demt(main):
            def delmdata(self):
                ...
                self.edm = Frame(self.fc1, bg='#581845', bd=0, relief='flat', width=130, height=35)
                self.edm.place(x=140, y=0)
                self.lac = Label(self.edm, text='SEARCH BOOKS ', bg='#581845', fg='#fff', font=('Calibri', 12, 'bold'))
                ...
                #Search Button
                self.butto = Button(self.fc1, text='SEARCH', bg='#581845', fg='#fff', width=8, font=('Calibri', 12, 'bold'),
            ...
            def srch(self):
                ...
                if self.srval != None:
                    ...
                    self.top.iconbitmap(r"C:\Users\THAMEEM\Desktop\PROJECT\library-management-files\filename\aa.ico")
    ...
    def show(self):
        class test(main):
            def __init__(self):
                self.fc = Frame(root, bg='#ffe8ec', width=900, height=390)
                self.fc.place(x=0, y=110)
                self.popframe = Frame(self.fc, width=180, height=30, bg='#581845')
                self.popframe.place(x=360, y=0)
                self.lbn = Label(self.popframe, bg='#581845', text='BOOKS INFORMATION', fg='#fff',
                                 font=('Calibri', 12, 'bold'))
    ...
    def code(self):
        ...
        self.photo = PhotoImage(file=r"C:\Users\THAMEEM\Desktop\PROJECT\library-management-files\filename\lib.png") #bg image
        ...
        #login button
        self.btn1 = Button(self.fm1, text='  Login', fg='black', bg='grey', width=100, height=50,font=('Arial', 11, 'bold'),
                           activebackground='black', activeforeground='yellow', command=self.login, bd=3, relief='flat',
                           cursor='hand2')
        self.btn1.place(x=25, y=160)
        self.logo = PhotoImage(file=r"C:\Users\THAMEEM\Desktop\PROJECT\library-management-files\filename\login.png") #image in login button
        self.btn1.config(image=self.logo, compound=LEFT)
        self.small_logo = self.logo.subsample(1, 1)
        self.btn1.config(image=self.small_logo)

        #clear button
        self.btn2 = Button(self.fm1, text='  Clear', fg='black', bg='grey', width=100,height=50, font=('Arial', 11, 'bold'),
        ...
        self.log = PhotoImage(file=r"C:\Users\THAMEEM\Desktop\PROJECT\library-management-files\filename\clear.png") #image in clear button
    ...
    def mouseClick(self, event):
        ...
        self.rog.iconbitmap(r"C:\Users\THAMEEM\Desktop\PROJECT\library-management-files\filename\aa.ico")
        self.rog.resizable(0, 0)
        self.rog.configure(bg='#000')

        self.framerog = Frame(self.rog, width=160, height=30, bg="grey")
        self.framerog.place(x=95, y=15)

        self.label = Label(self.framerog, text="SET NEW PASSWORD", bg='grey', fg='black', font=("Calibri", 12, 'bold'))
        ...
        #submit button
        self.btn1 = Button(self.rog, text='SUBMIT', fg='black', bg='grey', width=8, font=('Calibri', 12, 'bold'),
